...
class SettingsController extends Controller
{
    public function edit()
    {
        ...
        $upto_initial_discount = Setting::get('upto_initial_discount', 0); // default 0
        ...
        // dd($timezones);
        return view('admin.settings.index', compact('radius', 'initial_discount', 'upto_initial_discount', 'app_timezone', 'timezones', 'current_time'));
    }
    ...
    public function update(Request $request)
    {
        $request->validate([
            ...
            'upto_initial_discount' => 'required|numeric|min:0',
        ...
        Setting::set('upto_initial_discount', $request->upto_initial_discount);
